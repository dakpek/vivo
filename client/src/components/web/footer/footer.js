...
export default class Footer extends Component {
    ...
    submitForm = async (event) => {
        ...
        await axios.post("http://localhost:3001/email", {email: this.state.email})
        ...
        return (
            <div className="footerContainer">
                ...
                <div className="footerBoxes">
                    ...
                    ? <div className="footerSubmittedForm">
                        tesekkurler ;)
                        </div>
                    : <form onSubmit={this.submitForm} className="landingEmail">
                        <input 
