...
import { how0, how1, how2, how3, how4 } from '../../../assets/'
        ...
        return (
            <div className="howContainer">
                ...
                <div className="howMain">
                    ...
                    onun disinda adet donemin sadece sana ozel. Ve ______ de senin markan.
                    </div>
                    </div>
                    <img alt="howMainImg" className="howMainImg" src={how0} />
                </div>
                <div className="howLearnMore">+ Daha Fazla Ogren</div>
                <div className="howHeader">Nasil Calisir?</div>
                ...
                <div className="howWhy">
                    <div className="howWords"></div>
